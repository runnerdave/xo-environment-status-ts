# XO Environment status with Typescript

repo to practice converting a regular react app into a react-typescript one

```create-react-app xo-environment-status-ts --scripts-version=react-scripts-ts```
